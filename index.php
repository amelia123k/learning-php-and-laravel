...
if(isset($_POST["product_name"])){
    if(!empty($_POST["product_name"]) && !empty($_POST["price"]) && $_POST['price']>0 && !empty($_POST['quantity'])&& $_POST['quantity']>0 ){
...
array_push( $products,$_POST['product_name']);
 // saving product information to the file
    file_put_contents('stock.txt', $_POST['product_name'] . ' ' . $_POST['price'] . ' ' . $_POST['quantity'] . ' '. $total . PHP_EOL, FILE_APPEND);
